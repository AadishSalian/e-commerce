...
content = content.replace(oldSecuritySearch.trim(), oldSecuritySearch.trim() + "\n" + newSecurityAdd);


const oldNotificationsSearch = `
                  <div className="bg-surface border border-border rounded-3xl overflow-hidden shadow-sm">
                    <div className="p-6 md:p-8 border-b border-border flex justify-between items-center">
`;

const newNotificationsAdd = `
...
content = content.replace(oldNotificationsSearch.trim(), newNotificationsAdd + "\n" + oldNotificationsSearch.trim());
