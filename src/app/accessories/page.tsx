  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-foreground selection:text-background font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-[80vh] w-full pt-32 pb-16 px-4 md:px-8 flex items-center justify-center overflow-hidden">
        ...
        >
          <Image src="https://images.unsplash.com/photo-1492707892479-7bc8d5a4ee93?q=80&w=2000&auto=format&fit=crop" 
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 relative h-[600px]">
              ...
              >
                <Image src="https://images.unsplash.com/photo-1548036328-c9fa89d128fa?q=80&w=800&auto=format&fit=crop" 
              ...
              >
                <Image src="https://images.unsplash.com/photo-1505022610485-0249ba5b3675?q=80&w=600&auto=format&fit=crop" 
      ...
      <section className="py-24 px-4 md:px-8 max-w-7xl mx-auto w-full bg-background" id="collection">
          ...
          <div className="flex flex-wrap items-center gap-4 border-t border-border pt-6">
            ...
            <div className="relative min-w-[160px]">
              <CustomSelect
                ...
                variant="pill"
                options={materials.map(t => ({ label: t, value: t }))}
              />
            </div>
        ...
        {filteredProducts.length > 0 ? (
          <motion.div layout className="grid grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-8 md:gap-x-6 md:gap-y-12">
