...
export default function ElectronicsCategoryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0d0d] text-[#e8e8e6] selection:bg-accent selection:text-white font-sans overflow-x-hidden">
      ...
      {/* 3. Category Storytelling - Ecosystem */}
      <section className="py-32 w-full bg-[#111] mt-16">
      ...
      {/* 4. Category Storytelling - Material Obsession */}
      <section className="py-32 w-full bg-[#0d0d0d]">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
            ...
            >
              <img 
                src="https://images.unsplash.com/photo-1628202926206-c63a34b19fb4?q=80&w=1200&auto=format&fit=crop" 
