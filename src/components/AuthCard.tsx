...
import { Mail, Lock, User, Eye, EyeOff, AlertTriangle, Fingerprint } from 'lucide-react';
...
export default function AuthCard() {
  ...
  const handleBiometricLogin = async () => {
    try {
      ...
      if (!options.challenge) throw new Error('Failed to get challenge');
              ...
              >
                ...
                <div className="flex flex-col gap-3 mb-8">
                  {isLogin && (
                    <button 
                      type="button" 
                      className="w-full h-11 bg-surface border border-border hover:border-text-muted hover:bg-surface-hover rounded-xl flex items-center justify-center gap-2 text-sm font-medium transition-all" 
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <button type="button" className="flex-1 h-11 bg-surface border border-border hover:border-text-muted hover:bg-surface-hover rounded-xl flex items-center justify-center gap-2 text-sm font-medium transition-all">
